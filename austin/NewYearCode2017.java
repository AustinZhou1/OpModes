...
@TeleOp(name="NewYearCode2017", group="HatTricks")
public class NewYearCode2017 extends LinearOpMode {
    ...
    private float right_trigger, left_trigger, right_bumper, left_bumper;
    ...
    private void mergeGamePads() {
        ...
        private void mergeGamePads {
            // gamepad1 has the priority
            if (gamepad1.right_trigger || gamepad1.left_trigger || gamepad1.left_bumper || gamepad1.right_bumper) {
