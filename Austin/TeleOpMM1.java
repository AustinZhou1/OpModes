...
import org.firstinspires.ftc.teamcode.ColorSensorTest;
...
public class TeleOpMM extends LinearOpMode{
    ...
    private enum ShooterState {INIT, NORMAL, ELEVATOR, SHOOTER, SHOOT}

    private DcMotor mtrRF, mtrRM, mtrRB, shootR;        // Right side motors
    private DcMotor mtrLF, mtrLM, mtrLB, shootL;        // Left side motors
    private Servo pusher, sweeper, gate;
    ...
    // Nudge Control Finite State Machine Variables
    ...
    //Shooter Control Finite State Machine Variables
    private ShooterState shooterState = ShooterState.INIT;
    private long shootStarted;
    private boolean x, y, a, b;
    private double sweepSpeed, shootSpeed;
    ...
    private double pusherPosition, gatePosition;
    ...
    private void updateHardware() {
        ...
        shootR.setPower(shootSpeed);
        shootL.setPower(shootSpeed);
    ...
    private void executeShootControl() throws InterruptedException {
        final double OPEN = 1.0;
        final double FORWARD = 0.75;
        final double REVERSE = -0.75;
        final double FIRE = 0.75;
        ...
        switch (shooterState) {
            ...
            case NORMAL:
                if (a = true) {
                    shooterState = ShooterState.ELEVATOR;
                } else {
                    x = false;
                    y = false;
                    b = false;
            ...
            case ELEVATOR:
                if (a = true) {
                    shooterState = ShooterState.SHOOTER;
                } else if (b = true) {
                    shooterState = ShooterState.NORMAL;
                } else if (y = true) {
                    shooterState = ShooterState.NORMAL;
